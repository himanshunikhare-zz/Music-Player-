...
class GUI:
    ...
    def __init__(self, player):
        ...
        self.root.iconbitmap('icon1/mp.ico')
    ...
    def create_console_frame(self):                             
        ...
        photo = PhotoImage(file='icon1/glassframe.gif')
    ...
    def create_button_frame(self):
        ...
        #****************** Previous button ******************************** 
        previcon = PhotoImage(file='icon1/previous.gif')                                                    
        ...
        #******************** Rewind button ******************************** 
        rewindicon = PhotoImage(file='icon1/rewind.gif')                                                   
        ...
        #****************** Play/Pause button ******************************     
        self.playicon = PhotoImage(file='icon1/play.gif')
        self.stopicon = PhotoImage(file='icon1/stop.gif')
        ...
        #****************** fast forward button ***************************** 
        fast_fwdicon = PhotoImage(file='icon1/fast_fwd.gif')
        ...
        #****************** Next button ************************************* 
        nexticon = PhotoImage(file='icon1/next.gif')
        ...
        #****************** Mute/Unmute button *******************************         
        self.muteicon = PhotoImage(file='icon1/mute.gif')
        self.unmuteicon = PhotoImage(file='icon1/unmute.gif')
    ...
    def list_frame(self):
        ...
        self.listbox = Listbox(list_frame, activestyle='none', cursor='hand2', bg='#303030', fg='#ffffff', selectmode = EXTENDED, width= 70, heigh=10)
    ...
    def create_bottom_frame(self):
        ...
        #****************** Add file button *************************************         
        add_fileicon = PhotoImage(file='icon1/add_file.gif')
        ...
        del_selectedicon = PhotoImage(file='icon1/del_selected.gif')
        ...
        add_diricon = PhotoImage(file='icon1/add_dir.gif')
        ...
        #****************** Delete all button ************************************
        delallicon = PhotoImage(file='icon1/delall.gif')
