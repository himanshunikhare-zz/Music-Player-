...
class GUI:
    ...
    def create_console_frame(self):                             
        ...
        self.canvas.configure(background = '#e4e4e4')
    ...
    def list_frame(self):
        ...
        self.listbox = Listbox(list_frame, activestyle='none', cursor='hand2', bg='#00001e', fg='#ffffff', selectmode = EXTENDED, width= 70, heigh=10)
    ...
    def add_file(self):
        tfile = tkFileDialog.askopenfilename(filetypes=[('All supported', '.mp3 .wav'), ('.mp3 files', '.mp3'), ('.wav files','.wav'), ('.tatti','.shit.')])
